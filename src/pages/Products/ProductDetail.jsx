      ...
      {list && 
        <div className='mb-12'>
          ...
          <div className='flex max-sm:flex-col'>
            {/* image block */}
            <div className='max-sm:px-2 sm:w-1/2'>
              <img className='max-sm:rounded-md' src='/heroImage.png' alt='the graphic of the item' />
            </div>
            <div className='max-sm:w-full max-sm:px-2 w-1/2 p-4'>
