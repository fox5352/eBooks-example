...
export const Footer = () => {
  return (
    // make nicer
    <footer className='flex max-sm:flex-col align-middle max-sm:text-center justify-between w-3/4 mx-auto px-2 py-4 border-[1px] border-neutral-300 rounded-lg shadow-lg dark:border-slate-400 dark:shadow-slate-500'>
      <div className='flex max-sm:mb-4'>
        <p className='flex items-center'>{new Date().getFullYear() } CodeBooks example. All Rights Reserved</p>
      </div>

      <div className='flex max-sm:justify-center space-x-2 pr-2'>
